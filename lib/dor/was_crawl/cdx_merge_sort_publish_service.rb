  ...
  module WasCrawl
    class CdxMergeSortPublishService
      ...
      def sort_druid_cdx
        ...
        merge_cmd_string = "#{Settings.was_crawl_dissemination.sort_env_vars} sort #{@source_cdx_dir}*.cdx > #{@working_merged_cdx}"
      ...
      def merge_with_main_index
        ...
        sort_cmd_string = "#{Settings.was_crawl_dissemination.sort_env_vars} sort -u -m #{@working_merged_cdx} #{@main_cdx_file} > #{@working_sorted_cdx}"
      ...
      def clean
        ...
        FileUtils.rm_rf(@working_sorted_duplicate_cdx)
        FileUtils.rm_rf(@working_merged_cdx)
      end
    end
  end
end
