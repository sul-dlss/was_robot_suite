...
RSpec.describe Dor::WasCrawl::WarcExtractorService do
  describe '#extract' do
    ...
    context 'when the data package profile is multi-wacz-package with an absolute path as deployed' do
      before do
        FileUtils.cp_r 'spec/lib/dor/was_crawl/fixtures/workspace/ee111ee1111', 'tmp/'
      end
      ...
      it 'extracts the WARC files' do
        described_class.extract(File.expand_path('tmp/ee111ee1111'), 'Multi-WACZ-Test.wacz')
        expect(File.exist?(File.expand_path('tmp/ee111ee1111/Multi-WACZ-Test-stanford-library-website-fixture-wacz-manual-20240823165704-eb63421b-c8a-20240823165728702-0.warc.gz'))).to be true
        expect(File.exist?(File.expand_path('tmp/ee111ee1111/Multi-WACZ-Test-stanford-library-website-fixture-wacz-manual-20240823165704-eb63421b-c8a-screenshots-20240823165731628.warc.gz'))).to be false
        expect(File.exist?(File.expand_path('tmp/ee111ee1111/Multi-WACZ-Test-stanford-library-website-fixture-wacz-manual-20240823165704-eb63421b-c8a-text-20240823165731772.warc.gz'))).to be false
        expect(File.exist?(File.expand_path('tmp/ee111ee1111/Multi-WACZ-Test.wacz'))).to be false
      end
    end
  end
end
